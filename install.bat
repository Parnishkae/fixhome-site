...
echo.
echo  Запуск как приложение (окно + трей):  двойной клик по Misa.vbs
echo  Запуск в консоли:                     run.bat
echo.
echo  Красивый нейросетевой голос:          install-voice.bat
echo  Настроить ИИ-мозг (ключ):             python scripts\setup_ai.py
echo ============================================================
pause
